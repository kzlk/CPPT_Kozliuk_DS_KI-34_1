...
public abstract class Camera
{
    ...
    private ArrayList<Particle> photo;
...
class Memory
{
     ...
     */
    public Memory(int sizeOfMemory, String name, ArrayList<Particle> photoList)
    {
        this.name =  name;
     ...
     */
    public void updateMemory(Particle photo) {inUsageMemory  +=  photo.sizeMb;}
